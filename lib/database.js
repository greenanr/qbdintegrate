...
module.exports={
    ...
    xmlPush:function(userid, xml, callback) {
        ...
        queryStr = 'INSERT INTO qbd_xmlqueue (userid, xml) VALUES (' + userid + ', \"$1xmlqueue1$' + xml + '$1xmlqueue1$\");';
        console.log(queryStr);
        pgclient.query(queryStr, function(err, res) {
             if (err) return callback(err);
    ...
    xmlLogPush:function(userid, xml, callback) {
        ...
        queryStr = 'INSERT INTO qbd_xmllog (userid, xml) VALUES (' + userid + ', \"$1xmllog1$' + xml + '$1xmllog1$\");';
        console.log(queryStr);
        pgclient.query(queryStr, function(err, res) {
             if (err) return callback(err);
