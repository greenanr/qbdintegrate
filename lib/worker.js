...
function work(msg, cb) {
  ...
  try {
    if (msg != null) {
      ...
      console.log("Payload Id: " + json.payload.id);
      console.log("Company Id: " + json.payload.company_id);
      console.log("Department Id: " + json.payload.department_id);
      console.log("Department Name Id: " + json.payload.department_name);
      console.log("Supplier Id: " + json.payload.supplier_id);
      console.log("Supplier Name: " + json.payload.supplier_name);
      console.log("Supplier Id: " + json.payload.supplier_id);
      console.log("Supplier Email: " + json.payload.supplier_email);
      console.log("Supplier Address: " + json.payload.supplier_address);
      console.log("Status: " + json.payload.status);
      console.log("Creator Id " + json.payload.creator_id);
      console.log("Currency Id " + json.payload.currency_id);
      for (x=0; x < json.payload.purchase_order_items.length; x++) {
        console.log("ID " + json.payload.purchase_order_items[x].purchase_order_id);
        console.log("Description " + json.payload.purchase_order_items[x].description);
        console.log("Net Amount " + json.payload.purchase_order_items[x].net_amount);
